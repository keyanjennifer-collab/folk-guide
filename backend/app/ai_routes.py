...
def chat_ai(data: AIChatInput, user: User = Depends(current_user), db: Session = Depends(get_db)):
    ...
    try:
        message, before_quota, blocked = answer_ai_question(
            ...
            get_settings().ai_use_knowledge_base,
        )
    ...
    return {
        ...
        "model_name": message.model_name, "disclaimer": DISCLAIMER,
    }
...
def feedback(
    ...
    return {
        ...
        "feedback": message.feedback, "created_at": message.created_at,
    }
