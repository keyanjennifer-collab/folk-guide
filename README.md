...
当前界面以深色交互概念稿为准，以 `COLORO 129-15-00`（屏幕近似 `#262626`）为主视觉，叠加低对比岩面纹理，并包含「今日五色 / 产品商城 / AI国学 / 我的」四个入口。商城为一款五色线香套装与五款单香，支持详情和本机购物袋；下单与支付尚未开放。我的页面对接账号、档案、AI 权益/历史与本人订单只读接口。
...
一个“极薄微信小程序前端 + Python FastAPI 后端”的可运行项目。公开每日五色只展示运营后台人工确认并发布的资料；规则缓存不能直接作为公开排行。AI 国学问答支持模型自身知识；审核知识库和联网搜索都由后端开关控制。
